...
## This is for DAVID 2016 (6.8 version) - Jan 2016
...
go2016_Jan <- readRDS("../go_gaf_datasets/go2016Jan/go_2016_jan/human_go.Rds")
```
...
goJan2016_terms <- rev(stack(go2016_Jan))
str(goJan2016_terms)
...
GO0001654 <- goJan2016_terms[grep("GO:0001654",goJan2016_terms$ind),2]
GO0001764 <- goJan2016_terms[grep("GO:0001764",goJan2016_terms$ind),2]
GO0002682 <- goJan2016_terms[grep("GO:0002682",goJan2016_terms$ind),2]
...
saveRDS(ora_arranged2016, file = "ora_arranged2016Jan.RDS")
